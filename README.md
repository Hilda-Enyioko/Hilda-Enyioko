...
Currently, I’m **enhancing my backend and data visualization skills** to create smarter, data-driven e-commerce experiences.  
...
- 🛍️ **[Zada Afrique](#)** – A modern e-commerce platform for African fashion brands, focused on inclusivity, responsiveness, and clean UX.  
- 📰 **[Inclusive Talks](https://github.com/Hilda-Enyioko/Inclusive-Talks)** – A digital platform advocating for diversity and inclusion through community storytelling.  
- 🌱 **[GreenCart by EcoTribe](https://github.com/michaelEmeka/GreenCart)** – *Winner of Hack4FUTO: The Third.* A web app connecting businesses to trade recyclable materials and promote sustainability.  
- 💙 **[Nivea NG Clone](https://github.com/Hilda-Enyioko/Nivea-Clone)** – A sleek clone of the [Nivea Nigeria](https://www.nivea.ng) homepage built with JavaScript.  
...
- **Backend fundamentals** with Python and Node.js  
...
## ⚡ Fun Fact  
I love transforming complex ideas into **elegant, intuitive, and human-centered web experiences** ✨  
...
[![Twitter](https://img.shields.io/badge/X-000000?style=flat-square&logo=x&logoColor=white)](https://x.com/amarachii_e)